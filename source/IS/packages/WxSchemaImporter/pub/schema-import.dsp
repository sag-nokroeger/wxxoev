...
<BODY
	onLoad="setNavigation('/WxXXML/schema-import.dsp', '../WmRoot/doc/OnlineHelp/wwhelp/wwhimpl/js/html/wwhelp.htm#context=is_help&topic=IS_Packages_WmXSLTpkg_Scrn');">
	<DIV class="position">
		<TABLE WIDTH="100%">
			<TR>
			...
			<TR>
				<TD>
					<form id="importform" name="importform" class="form"
						action="/invoke/com.softwareag.wx.schemaimporter.pub.ui:uploadSchema" method="post"
						enctype="multipart/form-data">
						<TABLE width="100%" class="tableView">

							<TR>
								<TD class="heading" colspan=2>File Selection</TD>
							</TR>
							<tr>
								<td width="10%" class="oddrow-l">
									<p class="label">Schema file(s)</p>
								</td>
								<td width="90%" class="oddrow-l">
									<div class="fileinput-area" id="fileinput-area-schema">
										<input class="fileinput" type="file" multiple id="schemaFile" name="schemaFile"
											style="width:100%" />
										<label class="button" for="schemaFile">Browse...</label>
										<p id="filesForUpload">drop xsd files or zip files here...
										<p>
									</div>
								</td>
							</tr>
